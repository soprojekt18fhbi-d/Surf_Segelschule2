...
public class Hauptmenue extends JPanel {
	...
	public Hauptmenue() {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addComponent(lblHauptmen,
				GroupLayout.DEFAULT_SIZE, 980, Short.MAX_VALUE));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addComponent(lblHauptmen, GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE).addContainerGap()));
