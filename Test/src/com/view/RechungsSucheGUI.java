...
public class RechungsSucheGUI extends JPanel implements IObjektView {
	...
	public RechungsSucheGUI(IObjektModel models, RechnungAnzeigeStrg controllers) {
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(btnZeigeAlle, GroupLayout.PREFERRED_SIZE, 35,
		...
		// Wenn rechnungsID leer ist, dann wird eine Fehlermeldung ausgeworfen. Das
		// Programme wird auch nicht ausgeführt, wenn heim_Urlaub ==2 (Abbrechen) ist.
	...
	public void keineRechnungGewaehlt() {
		JOptionPane.showMessageDialog(null, "Bitte wählen Sie eine Rechnung aus", "Rechnung wählen",
