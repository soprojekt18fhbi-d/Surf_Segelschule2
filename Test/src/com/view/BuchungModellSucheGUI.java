				...
				.addGroup(gl_panel.createSequentialGroup()
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
										.addComponent(txtSearchbar, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtModellnummer, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panel.createSequentialGroup().addGap(6).addComponent(
										lblAusgewhlteModellnummer, GroupLayout.PREFERRED_SIZE, 22,
										GroupLayout.PREFERRED_SIZE)))
