...
import com.view.RechungsSucheGUI;
...
public class RechnungAnzeigeStrg {
	...
	public void getRechungDruck(int rechnungsID, int heim_urlaub) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Die Rechnung wurde in Ihrem Workspace erstellt", "Rechnung erstellt",
			...
			JOptionPane.showMessageDialog(null,
					"Falls Sie noch eine Rechnung geöffnet haben, schließen Sie diese bitte", "Rechnung schließen",
					JOptionPane.PLAIN_MESSAGE);
		}
	}
	...
	public void erstellePDF(String filename, int rechnungsID)
		...
		cell2 = new PdfPCell(new Phrase(
				"Sehr geehrter Damen und Herren, \nwir bedanken uns für Ihren Auftrag " + buchungsID
						+ ". Bitte zahlen Sie die Rechungssumme innerhalb der nächsten 14 Tage auf unser Bankkonto. ",
				font3));
		cell2.setBorder(0);
		...
		// Hier wird bei einem Verkauf das Verkaufsdatum ausgegeben und bei einer
		// Ausleihe das Ausleihdatum.
