...
public class AktiveBuchungen extends JPanel implements IObjektView { //Ben Kröncke
	 ...
	 * Create the panel.
	 */
	public AktiveBuchungen(IObjektModel models, BuchungBuchungAnzeigenStrg controllers) {
