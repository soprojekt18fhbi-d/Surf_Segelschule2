...
public class ModellAnedernGUI extends JPanel {
	...
	public ModellAnedernGUI() {
		...
		JLabel lblModellndern = new JLabel("Modell \u00E4ndern:");
		lblModellndern.setFont(new Font("Tahoma", Font.BOLD, 32));
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(lblModellndern, GroupLayout.PREFERRED_SIZE, 358, GroupLayout.PREFERRED_SIZE)
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(78)
					.addComponent(lblModellndern, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
